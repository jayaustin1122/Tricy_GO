...
import com.example.tricygo_final.models.AddOnModel
...
class AddOns : BottomSheetDialogFragment()  {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.title.setText("Add New Add-Ons")
    ...
    private fun uploadImage() {
        ...
        val reference = storage.reference.child("AddOnsProfile")
